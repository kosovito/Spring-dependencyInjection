...
public class AppConfig {
	...
	@Bean("miServicioSimpleConBean")
	public IServicio registrarMiServicio() {
		return new MiServicio();
	}
	
	@Primary
	@Bean("miServicioComplejoConBean")
	public IServicio registrarMiServicioComplejo() {
		return new MiServicioComplejo();
	}
	
	@Bean("itemsFactura")
	public List<ItemFactura> resitrarItems(){
		Producto producto1 = new Producto("Cámara Sony", 100);
		Producto producto2 = new Producto("Bicicleta Bianchi rueda 26", 200);
	...
	public List<ItemFactura> resitrarItemsOficina(){
